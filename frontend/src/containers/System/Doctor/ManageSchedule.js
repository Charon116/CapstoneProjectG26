...
class ManageSchedule extends Component {
    ...
    handleSaveSchedule = async () => {
        ...
        if(res && res.errCode === 0){
            ...
            toast.error("Error saveBulkCreate Doctor");
        }

        console.log('check result time: ',res)
    }
                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-6 form-group'>
                            ...
                            <DatePicker onChange={this.handleOnChangeDatePicker} className='form-control' selected={this.state.currentDate} minDate={yesterday} />
                        </div>
